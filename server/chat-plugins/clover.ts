	...
	clover: {
		...
		support() {
			...
			this.sendReplyBox(
				...
				`<p>Donating to <a href="https://ko-fi.com/feneto7">Mr. Sableye's Ko-Fi</a> will pay for server costs and server advertisement.</p>` +
		...
		contribute() {
			...
			this.sendReplyBox(
				...
				'<p>Repos: <a href="https://github.com/feneto7/clovermon-showdown">feneto7/clovermon-showdown</a> / <a href="https://github.com/feneto7/clovermon-showdown-client">Feneto7/clovermon-showdown-client</a></p>'
			);
		},
		usage: {
			tier: 'format',
